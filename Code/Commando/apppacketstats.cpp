   ...
   switch (app_packet_type)
	{
		...
		ADD_CASE(APPPACKETTYPE_COOPLEVELTRANSITIONEVENT);
		ADD_CASE(APPPACKETTYPE_COOPOBJECTIVESYNCEVENT);
		ADD_CASE(APPPACKETTYPE_COOPCONTROLLOCKEVENT);
		ADD_CASE(APPPACKETTYPE_COOPCAMERAEVENT);
		ADD_CASE(APPPACKETTYPE_COOPRESPAWNSTATEEVENT);
		ADD_CASE(APPPACKETTYPE_COOPLOBBYSTATEEVENT);
		...
		ADD_CASE(APPPACKETTYPE_COOPRESPAWNREQUESTEVENT);
		ADD_CASE(APPPACKETTYPE_COOPCHARACTERSELECTEVENT);
		ADD_CASE(APPPACKETTYPE_COOPLOBBYREADYEVENT);
